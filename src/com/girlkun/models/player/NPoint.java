...
public class NPoint {
    ...
    private void setHpMax() {
        ...
        if (this.player.isPet && ((Pet) this.player).typePet == 13// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA) {
            this.hpMax += ((long) this.hpMax * 2);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 14// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA) {
            this.hpMax += ((long) this.hpMax  * 100 / 100);//chi so hp
        }
        //pet mabư
        if (this.player.isPet && ((Pet) this.player).typePet == 1
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA2) {
            this.hpMax += ((long) this.hpMax * 2 * 35 / 100);
        }
        //pet berus
        if (this.player.isPet && ((Pet) this.player).typePet == 2// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA2) {
            this.hpMax += ((long) this.hpMax * 2 * 55 / 100);//chi so hp
        }
        
        if (this.player.isPet && ((Pet) this.player).typePet == 12// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA2) {
            this.hpMax += ((long) this.hpMax * 2 * 155 / 100);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 13// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA2) {
            this.hpMax += ((long) this.hpMax * 2 * 65 / 100);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 14// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA2) {
            this.hpMax += ((long) this.hpMax * 2 * 115 / 100);//chi so hp
        }
        //pet mabư
        if (this.player.isPet && ((Pet) this.player).typePet == 1
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.hpMax += ((long) this.hpMax * 3 * 50 / 100);
        }
        //pet berus
        if (this.player.isPet && ((Pet) this.player).typePet == 2// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.hpMax += ((long) this.hpMax * 3 * 70 / 100);//chi so hp
        }
        
        if (this.player.isPet && ((Pet) this.player).typePet == 12// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.hpMax += ((long) this.hpMax * 3 * 170 / 100);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 13// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.hpMax += ((long) this.hpMax * 3 * 80 / 100);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 14// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.hpMax += ((long) this.hpMax * 3 * 130 / 100);//chi so hp
        }
        //pet mabư
        if (this.player.isPet && ((Pet) this.player).typePet == 1
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.hpMax += ((long) this.hpMax * 4 * 70 / 100);
        }
        //pet berus
        if (this.player.isPet && ((Pet) this.player).typePet == 2// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.hpMax += ((long) this.hpMax * 4 * 90 / 100);//chi so hp
        }
        
        if (this.player.isPet && ((Pet) this.player).typePet == 12// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.hpMax += ((long) this.hpMax * 4 * 190 / 100);//chi so hp
        }
        ...
        if (this.player.isPet && ((Pet) this.player).typePet == 14// anibus
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.hpMax += ((long) this.hpMax * 4 * 150 / 100);//chi so hp
        }
        //phù
    ...
    private void setMpMax() {
        ...
        if (this.player.isPet && ((Pet) this.player).typePet == 2
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA) {
            this.mpMax += ((long) this.mpMax * 2 * 40 / 100);//MP berus
        }
        
         if (this.player.isPet && ((Pet) this.player).typePet == 12// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA) {
            this.mpMax += ((long) this.mpMax * 2 * 140 / 100);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 13// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA) {
            this.mpMax += ((long) this.mpMax * 2 * 50 / 100);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 14// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA) {
            this.mpMax += ((long) this.mpMax * 2 * 100 / 100);//chi so hp
        }
    ...
    private void setDame() {
        ...
        if (this.player.isPet && ((Pet) this.player).typePet == 12// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA) {
            this.dame += ((long) this.dame * 2 * 140 / 100);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 13// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA) {
            this.dame += ((long) this.dame * 2 * 60 / 100);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 14// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA) {
            this.dame += ((long) this.dame * 2 * 100 / 100);//chi so hp
        }
         //pet mabư
        if (this.player.isPet && ((Pet) this.player).typePet == 1
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA2) {
            this.dame += ((long) this.dame * 2 * 35 / 100);
        }
        //pet mabư
        if (this.player.isPet && ((Pet) this.player).typePet == 2
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA2) {
            this.dame += ((long) this.dame * 2 * 55 / 100);
        }
        
        if (this.player.isPet && ((Pet) this.player).typePet == 12// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA2) {
            this.dame += ((long) this.dame * 2 * 155 / 100);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 13// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA2) {
            this.dame += ((long) this.dame * 2 * 75 / 100);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 14// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA2) {
            this.dame += ((long) this.dame * 2 * 115 / 100);//chi so hp
        } //pet mabư
        if (this.player.isPet && ((Pet) this.player).typePet == 1
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.dame += ((long) this.dame * 2.5 * 50 / 100);
        }
        //pet mabư
        if (this.player.isPet && ((Pet) this.player).typePet == 2
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.dame += ((long) this.dame * 2.5 * 70 / 100);
        }
        
        if (this.player.isPet && ((Pet) this.player).typePet == 12// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.dame += ((long) this.dame * 2.5 * 170 / 100);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 13// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.dame += ((long) this.dame * 2.5 * 90 / 100);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 14// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.dame += ((long) this.dame * 2.5 * 130 / 100);//chi so hp
        } //pet mabư
        if (this.player.isPet && ((Pet) this.player).typePet == 1
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.dame += ((long) this.dame * 3 * 50 / 100);
        }
        //pet mabư
        if (this.player.isPet && ((Pet) this.player).typePet == 2
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.dame += ((long) this.dame * 3 * 70 / 100);
        }
        
        if (this.player.isPet && ((Pet) this.player).typePet == 12// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.dame += ((long) this.dame * 3 * 150 / 100);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 13// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.dame += ((long) this.dame *3 * 90 / 100);//chi so hp
        }

        if (this.player.isPet && ((Pet) this.player).typePet == 14// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.dame += ((long) this.dame * 3 * 100 / 100);//chi so hp
        }
...
//                }
    ...
    public long calSubTNSM(long tiemNang) {
        ...
        else if(power <= 1700000000000L && power >= 1500000000000L) tiemNang += ((long) tiemNang / 60);
        else if(power <= 1800000000000L && power >= 1700000000000L) tiemNang += ((long) tiemNang / 700);
