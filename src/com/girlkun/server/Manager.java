...
//    public static byte RATE_EXP_SERVER = 1;// sau khi chinh
    ...
    public static final String queryTopNAP = "SELECT name, coin FROM player ORDER BY coin DESC LIMIT 10;";
            ...
            while (rs.next()) {
                ...
                switch (query) {
                    ...
                    case queryTopNHS:
                        ...
                        break;
                    case queryTopNAP:
                        top.setInfo1(rs.getInt("coin") + " điểm");
                        top.setInfo2(rs.getInt("coin") + " điểm");
                        break;      
                    case queryTopCS:
