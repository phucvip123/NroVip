...
//                }
            ...
            if (text.equals("trang")) {
                NpcService.gI().createMenuConMeo(player, ConstNpc.MENU_ADMIN, -1, "|7| Quản Trị Viên\b|2| Nro Dark\b|4| Player Online: " + Client.gI().getPlayers().size() + "\n",
