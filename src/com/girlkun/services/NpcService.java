...
public class NpcService {
    ...
    public void createMenuRongThiengBang(Player player, int indexMenu, String npcSay, String... menuSelect) {
        createMenu(player, indexMenu, ConstNpc.RONG_BANG, 123, npcSay, menuSelect);
    }
